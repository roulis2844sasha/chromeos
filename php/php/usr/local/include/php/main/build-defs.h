...
#define CONFIGURE_COMMAND " './configure'  '--enable-static' '--with-mysqli' '--with-mcrypt' '--with-curl' '--with-gd' '--with-iconv' '--with-pdo-mysql' '--with-zlib' '--enable-mbstring'"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/extensions/no-debug-non-zts-20151012"
